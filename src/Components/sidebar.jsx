              ...
              {collapsedSection === 'requests' && (
                <div className="collapse show">
                  <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 ms-3">
                    <li className="nav-link m-link">
                      <Link to="/pending" className="nav-link m-link link-body-emphasis text-decoration-none rounded">
                        <span className='icon'><MdOutlinePendingActions style={{ fontSize: "33px" }} /></span>
                        <span className="text nav-text">Pending</span>
                      </Link>
                    </li>
                    <li className="nav-link m-link">
                      <Link to="/approved" className="nav-link link-body-emphasis text-decoration-none rounded">
                        <span className='icon'><FaRegThumbsUp style={{ fontSize: "33px" }} /></span>
                        <span className="text nav-text">Approved</span>
                      </Link>
                    </li>
                    <li className="nav-link m-link">
                      <Link to="/declined" className="nav-link link-body-emphasis text-decoration-none rounded">
            ...
            <li className={`my-2 nav-link d-flex flex-column ${collapsedSection === 'inventory' ? 'expanded' : ''}`}>
              ...
              {collapsedSection === 'inventory' && (
                <div className="collapse show">
                  <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 ms-3">
                    <li className="nav-link m-link">
                      <Link to="/inbound" className="nav-link m-link link-body-emphasis text-decoration-none rounded">
                        <span className='icon'><RiArrowTurnBackFill style={{ fontSize: "33px" }} /></span>
                        <span className="text nav-text">Inbound</span>
                      </Link>
                    </li>
                    <li className="nav-link m-link">
                      <Link to="/outbound" className="nav-link m-link link-body-emphasis text-decoration-none rounded">
                        <span className='icon'><RiArrowTurnForwardFill style={{ fontSize: "33px" }} /></span>
                        <span className="text nav-text">Outbound</span>
                      </Link>
                    </li>
                    <li className="nav-link m-link">
                      <Link to="/scan-items" className="nav-link link-body-emphasis text-decoration-none rounded">
                        <span className='icon'><MdOutlineQrCodeScanner style={{ fontSize: "33px" }} /></span>
                        <span className="text nav-text">Scan Items</span>
                      </Link>
                    </li>
                    <li className="nav-link m-link">
                      <Link to="/categories" className="nav-link link-body-emphasis text-decoration-none rounded">
            ...
            <li className={`my-2 nav-link d-flex flex-column ${collapsedSection === 'reports' ? 'expanded' : ''}`}>
              ...
              {collapsedSection === 'reports' && (
                <div className="collapse show">
                  <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 ms-3">
                    <li className="nav-link m-link">
                      <Link to="/delivery-report" className="nav-link m-link link-body-emphasis text-decoration-none rounded">
                        <span className='icon'><TbReport style={{ fontSize: "33px" }} /></span>
                        <span className="text nav-text">Delivery Report</span>
                      </Link>
                    </li>
                    <li className="nav-link m-link">
                      <Link to="/growth" className="nav-link link-body-emphasis text-decoration-none rounded">
