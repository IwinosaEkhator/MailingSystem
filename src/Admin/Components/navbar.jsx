...
const Navbar = () => {
    ...
    return (
        <>
            <header className="pb-3 px-5 mb-4 border-bottom dashboard-navbar d-flex justify-content-between">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="dropdown">
                            <FaBell className='me-3 dropdown-toggle' style={{ color: "var(--black1)", fontSize: "20px" }} data-bs-toggle="dropdown" aria-expanded="false" />
